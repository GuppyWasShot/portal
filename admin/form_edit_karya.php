...
<div class="p-8">
    ...
    <div class="bg-white rounded-xl shadow-md p-6">
        ...
        <form action="proses_edit_karya.php" method="POST" enctype="multipart/form-data" class="space-y-6">
...
function deleteFile(id) {
    if (confirm('Hapus file ini?')) {
        window.location.href = 'delete_file.php?id=' + id + '&project=<?php echo $id_project; ?>';
    }
}

function deleteLink(id) {
    if (confirm('Hapus link ini?')) {
        window.location.href = 'delete_link.php?id=' + id + '&project=<?php echo $id_project; ?>';
    }
}
</script>
